<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminFooter.aspx.cs" Inherits="TravelWebsite.AdminFooter" %>
			...
			<div class="footer-top-grids">
				<div class="footer-grids">
                    ...
                    <h4>Our Products</h4>
						<ul>
							<li>
					<li><a href="AdminHome.aspx" target="bottomframe">Home</a><span>  </span></li>
					<li><a href="AdminLocation.aspx" target="bottomframe">Location</a><span>  </span></li>
					<li><a href="AdminUser.aspx" target="bottomframe">User</a><span>  </span></li>
					<li><a href="AdminResorts.aspx" target="bottomframe">Resorts</a><span>  </span></li>
					<li><a href="AdminCamp.aspx" target="bottomframe">Camp</a><span>  </span></li>
					<li><a href="index3.aspx" target="_parent">Homepage</a><span>  </span></li>
						</ul>
					</div>
                    <div class="col-md-3 footer-grid" >
