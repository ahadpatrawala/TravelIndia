<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="TravelWebsite.ChangePassword" %>
...
<div class="header">
    ...
    <td>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ForeColor="Red" ErrorMessage="Enter valid Username" ControlToValidate="txtUsername"></asp:RequiredFieldValidator>
        </td>
    </tr>
     <tr>
    ...
    <td>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ForeColor="Red" ErrorMessage="Enter password" ControlToValidate="txtpwd"></asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
    <td>New password: </td>
    <td>
        ...
        <asp:RequiredFieldValidator ID="rfvNewPwd" runat="server" ControlToValidate="txtNewPwd" ErrorMessage="Please enter new password" ForeColor="Red"></asp:RequiredFieldValidator>
    </td>
    </tr>
    <tr>
    ...
    <td>
        ...
        <br />
        <asp:CompareValidator ID="cmvConfirmPwd" runat="server" ControlToCompare="txtNewPwd" ControlToValidate="txtConfirmPwd" ErrorMessage="Password didn't match" ForeColor="Red"></asp:CompareValidator>
    </td>
    </tr>
    <tr>
    <td>&nbsp;</td>
