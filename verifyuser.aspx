<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="verifyuser.aspx.cs" Inherits="TravelWebsite.verifyuser" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <td>Email Id : </td><td>
        ...
        <asp:RegularExpressionValidator ID="revEmailId" runat="server" ErrorMessage="Please enter valid email address" ControlToValidate="txtEmailId" ForeColor="Red" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
         </td><td>
             <br />
        </td>
    </tr>
     <tr>
        ...
        Secret Question:</td><td>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Select Secret Question" ControlToValidate="DropDownList1"></asp:RequiredFieldValidator>
        </td>
        </tr>
    <tr>
        <td>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Enter Answer" ForeColor="Red" ControlToValidate="txtAnswer"></asp:RequiredFieldValidator>
        </td>
        </tr>
    <tr>
    <td>&nbsp;</td><td>
