<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs" Inherits="TravelWebsite.ResetPassword" %>
   ...
   <div align="center">
    ...
    <td>
        ...
        <asp:CompareValidator ID="cmvConfirmPwd" runat="server"
            ...
            Display="Dynamic" ErrorMessage="Password didn't match" ForeColor="Red"></asp:CompareValidator>
    </td>
    </tr>
    <tr>
    <td>
