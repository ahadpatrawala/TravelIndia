<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gangtok.aspx.cs" Inherits="TravelWebsite.gnagtok" %>
...
<body>
	...
	<!-- banner-bottom -->
		...
		<div class="c-rooms">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<div class="p-table">
                    <asp:Label ID="Label1" runat="server" Text="Club Mahindra Gangtok" ForeColor="#0D2DC2" Font-Bold="True" Font-Size="Large"></asp:Label>
						...
						<div class="col-md-3 p-table-grid">
							...
							<div class="rate-features">
							    ...
							    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                    ...
                                    SelectCommand="SELECT [basic_info] FROM [Gangtok] WHERE ([R_id] = @R_id)">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="FormView1" DefaultValue="1021" Name="R_id" 
						...
						<div class="col-md-3 p-table-grid">
							...
							<div class="avg-rate">								
                                ...
                                <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                                    ConnectionString="<%$ ConnectionStrings:TravelTourismConnectionString2 %>" 
                                    SelectCommand="SELECT [price] FROM [Gangtok] WHERE ([R_id] = @R_id)">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="FormView2" DefaultValue="1021" Name="R_id" 
                                            PropertyName="SelectedValue" Type="Int64" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                                </span>
                ...
                <div class="p-table">
                 <asp:Label ID="Label4" runat="server" Text="Sterling Gangtok - Delisso Abode" ForeColor="#0D2DC2" Font-Bold="True" Font-Size="Large"></asp:Label>
					<div class="p-table-grids">
						<div class="col-md-3 p-table-grid">
							<div class="p-table-grad-heading">
								<h6>Resort Information</h6>
						...
						<div class="col-md-3 p-table-grid">
							...
							<div class="rate-features">
							    ...
							    <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                                    ...
                                    SelectCommand="SELECT [basic_info] FROM [Gangtok] WHERE ([R_id] = @R_id)">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="FormView3" DefaultValue="1022" Name="R_id" 
                                            PropertyName="SelectedValue" Type="Int64" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
							</div>
						...
						<div class="col-md-3 p-table-grid">
							...
							<div class="avg-rate">								
                                ...
                                <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
                                    ...
                                    SelectCommand="SELECT [price] FROM [Gangtok] WHERE ([R_id] = @R_id)">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="FormView4" DefaultValue="1022" Name="R_id" 
                                            PropertyName="SelectedValue" Type="Int64" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                                </span>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <div class="p-table">
                 <asp:Label ID="Label6" runat="server" Text="MAYFAIR Spa Resort & Casino" ForeColor="#0D2DC2" Font-Bold="True" Font-Size="Large"></asp:Label>
					<div class="p-table-grids">
						<div class="col-md-3 p-table-grid">
							<div class="p-table-grad-heading">
								<h6>Resort Information</h6>
						...
						<div class="col-md-3 p-table-grid">
							...
							<div class="rate-features">
							    ...
							    <asp:SqlDataSource ID="SqlDataSource5" runat="server" 
                                    ...
                                    SelectCommand="SELECT [basic_info] FROM [Gangtok] WHERE ([R_id] = @R_id)">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="FormView5" DefaultValue="1023" Name="R_id" 
                                            PropertyName="SelectedValue" Type="Int64" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
							</div>
						...
						<div class="col-md-3 p-table-grid">
							...
							<div class="avg-rate">								
                                ...
                                <asp:SqlDataSource ID="SqlDataSource6" runat="server" 
                                    ...
                                    SelectCommand="SELECT [price] FROM [Gangtok] WHERE ([R_id] = @R_id)">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="FormView6" DefaultValue="1023" Name="R_id" 
                                            PropertyName="SelectedValue" Type="Int64" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                                </span>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<div class="p-table">
                 <asp:Label ID="Label7" runat="server" Text="The elgin nor-khill" ForeColor="#0D2DC2" Font-Bold="True" Font-Size="Large"></asp:Label>
					<div class="p-table-grids">
						<div class="col-md-3 p-table-grid">
							<div class="p-table-grad-heading">
								<h6>Resort Information</h6>
						...
						<div class="col-md-3 p-table-grid">
							...
							<div class="rate-features">
							    ...
							    <asp:SqlDataSource ID="SqlDataSource7" runat="server" 
                                    ...
                                    SelectCommand="SELECT [basic_info] FROM [Gangtok] WHERE ([R_id] = @R_id)">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="FormView7" DefaultValue="1024" Name="R_id" 
                                            PropertyName="SelectedValue" Type="Int64" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
							</div>
						...
						<div class="col-md-3 p-table-grid">
							...
							<div class="avg-rate">								
                                ...
                                <asp:SqlDataSource ID="SqlDataSource8" runat="server" 
                                    ...
                                    SelectCommand="SELECT [price] FROM [Gangtok] WHERE ([R_id] = @R_id)">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="FormView8" DefaultValue="1024" Name="R_id" 
                                            PropertyName="SelectedValue" Type="Int64" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                                </span>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<div class="p-table">
                 <asp:Label ID="Label8" runat="server" Text="Saramsa Resort" Font-Bold="True" Font-Size="Large" ForeColor="#0D2DC2"></asp:Label>
					<div class="p-table-grids">
						<div class="col-md-3 p-table-grid">
							<div class="p-table-grad-heading">
								<h6>Resort Information</h6>
						...
						<div class="col-md-3 p-table-grid">
							...
							<div class="rate-features">
							    ...
							    <asp:SqlDataSource ID="SqlDataSource9" runat="server" 
                                    ...
                                    SelectCommand="SELECT [basic_info] FROM [Gangtok] WHERE ([R_id] = @R_id)">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="FormView9" DefaultValue="1025" Name="R_id" 
                                            PropertyName="SelectedValue" Type="Int64" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
							</div>
						...
						<div class="col-md-3 p-table-grid">
							...
							<div class="avg-rate">								
                                ...
                                <asp:SqlDataSource ID="SqlDataSource10" runat="server" 
                                    ...
                                    SelectCommand="SELECT [price] FROM [Gangtok] WHERE ([R_id] = @R_id)">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="FormView10" DefaultValue="1025" Name="R_id" 
                                            PropertyName="SelectedValue" Type="Int64" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                                </span>
