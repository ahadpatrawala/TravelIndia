<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index2.aspx.cs" Inherits="TravelWebsite.index2" %>
...
<!-- //js -->
<!-- fonts -->
<link href='http://localhost:2405/fonts.googleapis.com/css?family=Roboto:400,100,100italic,300,300italic,400italic,500,700,500italic,700italic,900,900italic' rel='stylesheet' type='text/css'>
<link href='http://localhost:2405/fonts.googleapis.com/css?family=Open+Sans:400,300,300italic,400italic,600,600italic,700,700italic,800,800italic' rel='stylesheet' type='text/css'>
    <style type="text/css">
        .style2
        {
            margin-left: 40px;
...
<body background="images/travel_HD (1).jpg"  >
	...
	<div class="header">
		<div class="container">
			<div class="header-grids">
								<div class="logo">
					<h1>
                        <asp:HyperLink ID="logohome" runat="server" NavigateUrl="~/index2.aspx" ForeColor="#0D2DC2"><span>Travel</span></asp:HyperLink>india</h1>
				</div>
				<!--navbar-header-->
			...
			<div class="nav-top">
                ...
                <li><asp:HyperLink ID="HyperLink5" runat="server" NavigateUrl="~/Camp.aspx">Camp</asp:HyperLink></li></ul>
					<div class="style4"><asp:HyperLink ID="HyperLink6" runat="server" ForeColor="#0D2DC2" Font-Size="Medium" NavigateUrl="~/Changepassword.aspx">Change Password</asp:HyperLink>
                        <br />
                        <br />
                <asp:Label ID="lbllsession" runat="server" Text="Label"  ForeColor="#0D2DC2" Font-Size="Large"></asp:Label></div>
                    <div class="clearfix"> 
                    </div>
					<!-- script-for-menu -->
							 <script>
    ...
    <div class="move-text">
		<div class="marquee" 
            style="font-family: 'Lato Light'; font-size: large; font-weight: bold; font-style: italic; color: #0D2DC6;">Welcome to Travelindia!!</div>
